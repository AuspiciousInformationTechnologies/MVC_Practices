...
namespace DAL_Data_Access_Layer_
{
    ...
    public class ADOContext
    {
        ...
        public string readConfig(int val=1)
        {
            string _connString = "";
            try
            {
                ...
                {
                    _connString = ConfigurationManager.ConnectionStrings["FortisDbContextMDM"].ToString();
                }
        ...
        public DataTable ExecSQLProc(string spName, SqlParameter[] param,int val)
        {
            SqlConnection connection = null;
            DataTable dt = new DataTable();
            try
            {
                connection = new SqlConnection(readConfig(val));
        ...
        public DataSet ExecDsSQLProc(string spName, SqlParameter[] param,int val)
        {
            SqlConnection connection = null;
        ...
        public DataTable ExecSQLProcDT(string spName,int val)
        {
            SqlConnection connection = null;
            DataTable dt = new DataTable();
            try
        ...
        public DataSet ExecSQLProcDS(string spName, int val)
        {
            SqlConnection connection = null;
        ...
        public DataTable GetDataTableByCmdText(string commandText,int val)
        {
            SqlConnection connection = null;
            DataTable dt = new DataTable();
            try
        ...
        public DataTable GetDataTableByCmdText(string commandText, SqlParameter[] param,int val)
        {
            SqlConnection connection = null;
            DataTable dt = new DataTable();
            try
        ...
        public DataSet GetDataByCmdText(string commandText, int val)
        {
            SqlConnection connection = null;
            DataSet ds = new DataSet();
            try
        ...
        public DataSet GetDataByCmdText(string commandText, SqlParameter[] param, int val)
        {
            SqlConnection connection = null;
            DataSet ds = new DataSet();
            try
        ...
        public int ExecuteNonQuery(string spName, SqlParameter[] param, int option,int val)
        {
            int retvalue = 0;
            SqlConnection connection = new SqlConnection(readConfig(val));
            try
            {
        ...
        public DataSet ExecDsSQLProcMDM(string spName, SqlParameter[] param)
        {
            SqlConnection connection = null;
            DataSet dt = new DataSet();
            try
            {
                connection = new SqlConnection(readConfigMDM());
                SqlCommand command = new SqlCommand();
                command.Connection = connection;
                command.CommandText = spName;
                command.CommandType = CommandType.StoredProcedure;
