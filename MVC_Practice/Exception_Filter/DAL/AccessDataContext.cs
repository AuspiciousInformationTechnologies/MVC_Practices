...
namespace Exception_Filter.DAL
{
    //public class AccessDataContext
    //{
       

    //    //public DataSet ReturnDS(SqlParameter[] abc,string procedurename)
    //    //{
    ...
    {
        MVC_PracticeEntities mentites = new MVC_PracticeEntities();
        ...
        public string readConfig()
        {
            ...
            try
            {
                _connString = ConfigurationManager.ConnectionStrings["MVC_PracticeEntities"].ToString();
        ...
        public string readConfigAdoConnection()
        {
            string _connString = "";
            try
            {
                _connString = ConfigurationManager.ConnectionStrings["MVC_AdoConnection"].ToString();
        ...
        //            con.Open();
        //            DataSet ds = UrlHelper.ExecuteDataset(con, CommandType.Text, sqlStatement);
        ...
        public DataSet ExecDsSQLProcAdoConnection(string spName, SqlParameter[] param)
        {
            SqlConnection connection = null;
            DataSet dt = new DataSet();
            try
            {
                connection = new SqlConnection(readConfigAdoConnection());
                SqlCommand command = new SqlCommand();
                command.Connection = connection;
                command.CommandText = spName;
                command.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable ExecDtSQLProcAdoConnection(string spName, SqlParameter[] param)
        {
            SqlConnection connection = null;
            DataTable dt = new DataTable();
            try
        ...
        public DataTable Ado_ExecSQLProc(string spName, SqlParameter[] param)
        {
            SqlConnection connection = null;
            DataTable dt = new DataTable();
            try
